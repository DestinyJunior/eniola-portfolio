                    ...
                    <div class="space-y-[63px]">
                        <div class="text-[#333333] sm:text-2xl font-normal">
                            <p class="leading-[150%]">I am a collaborative designer with
                                ...
                                visually
                                beautiful. I have a solid understanding of design principles such as colour theory,
                                layout, white space and typography.
                            </p>
                            <br>
                            <p class="leading-[150%]"> I am skilled in a number of design software packages, including
                                Adobe Illustrator,
                                Adobe
                                Photoshop and Corel Draw.</p>
                            <br>
                            <p class="leading-[150%]">I love making new friends and understanding how they solve
                                problems; which is one of
                                the
                                reasons why I invest my time in gatherings ranging from product management to
                                everything
                                related to design (research, design thinking, design system, etc.) and talking to
                                people
                                in general, as every opportunity to learn something new is always welcome. When I'm
                                building my solutions, I see it as an opportunity to grow myself as a professional
                                and
